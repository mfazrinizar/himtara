...
import {
  ...
  useApproveGem,
  useRejectGem,
  useRevalidateAllCache,
  useRevalidateSpecificCache,
...
export function AdminDashboardPage() {
  const [mainTab, setMainTab] = useState<"gems" | "users" | "settings">("gems");
  ...
  const revalidateAllMutation = useRevalidateAllCache();
  const revalidateSpecificMutation = useRevalidateSpecificCache();
  ...
  const handleRevalidateAll = async () => {
    try {
      ...
      toast.error("Gagal me-refresh cache");
    }
  };
  ...
  const handleRevalidateSpecific = async (
    ...
    try {
      const result = await revalidateSpecificMutation.mutateAsync(cacheType);
      if (result.success) {
        toast.success(result.message);
      } else {
        toast.error(result.message);
              ...
              <Card className="border-2 shadow-xl">
                ...
                <CardContent className="space-y-6">
                  <p className="text-muted-foreground">
                    Cache digunakan untuk mempercepat loading data. Refresh
                    cache jika data tidak sinkron atau setelah melakukan
                    perubahan besar.
                  </p>

                  {/* Refresh All Cache */}
                  <div className="p-4 rounded-lg border-2 border-border bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Hapus semua cache dan muat ulang data terbaru dari
                          database
                        </p>
                      </div>
                      <Button
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {/* Gems Cache */}
                    <div className="p-4 rounded-lg border-2 border-emerald-200 dark:border-emerald-800 bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950 dark:to-emerald-900">
                      ...
                      <p className="text-sm text-emerald-700 dark:text-emerald-300 mb-3">
                        Daftar destinasi, pencarian, dan detail
                      </p>
                      <Button
                        onClick={() => handleRevalidateSpecific("gems")}
                        disabled={revalidateSpecificMutation.isPending}
                        variant="outline"
                        size="sm"
                        className="w-full gap-2 border-emerald-300 dark:border-emerald-700 hover:bg-emerald-200 dark:hover:bg-emerald-800"
                      >
                        <RefreshCw
                          className={`w-4 h-4 ${
                            revalidateSpecificMutation.isPending
                              ? "animate-spin"
                              : ""
                          }`}
                        />
                    ...
                    {/* Reviews Cache */}
                    <div className="p-4 rounded-lg border-2 border-amber-200 dark:border-amber-800 bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-950 dark:to-amber-900">
                      <div className="flex items-center gap-3 mb-3">
                      ...
                      <p className="text-sm text-amber-700 dark:text-amber-300 mb-3">
                        Ulasan dan rating destinasi
                      </p>
                      <Button
                        onClick={() => handleRevalidateSpecific("reviews")}
                        disabled={revalidateSpecificMutation.isPending}
                        variant="outline"
                        size="sm"
                        className="w-full gap-2 border-amber-300 dark:border-amber-700 hover:bg-amber-200 dark:hover:bg-amber-800"
                      >
                        <RefreshCw
                          className={`w-4 h-4 ${
                            revalidateSpecificMutation.isPending
                    ...
                    {/* Stats Cache */}
                    <div className="p-4 rounded-lg border-2 border-blue-200 dark:border-blue-800 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900">
                      <div className="flex items-center gap-3 mb-3">
                      ...
                      <p className="text-sm text-blue-700 dark:text-blue-300 mb-3">
                        Statistik destinasi dan pengguna
                      </p>
                      <Button
                        onClick={() => handleRevalidateSpecific("stats")}
                        disabled={revalidateSpecificMutation.isPending}
                        variant="outline"
                        size="sm"
                        className="w-full gap-2 border-blue-300 dark:border-blue-700 hover:bg-blue-200 dark:hover:bg-blue-800"
                      >
                        <RefreshCw
                          className={`w-4 h-4 ${
                            revalidateSpecificMutation.isPending
                    ...
                    {/* Users Cache */}
                    <div className="p-4 rounded-lg border-2 border-purple-200 dark:border-purple-800 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900">
                      <div className="flex items-center gap-3 mb-3">
                      ...
                      <p className="text-sm text-purple-700 dark:text-purple-300 mb-3">
                        Data dan statistik pengguna
                      </p>
                      <Button
                        onClick={() => handleRevalidateSpecific("users")}
                        disabled={revalidateSpecificMutation.isPending}
                        variant="outline"
                        size="sm"
                        className="w-full gap-2 border-purple-300 dark:border-purple-700 hover:bg-purple-200 dark:hover:bg-purple-800"
                      >
                        <RefreshCw
                          className={`w-4 h-4 ${
                            revalidateSpecificMutation.isPending
                  ...
                  <div className="p-4 rounded-lg bg-muted/50 border border-border">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-sm text-muted-foreground">
                        <p className="font-medium mb-1">Informasi Cache:</p>
                        <ul className="list-disc list-inside space-y-1">
                          <li>Cache destinasi: 1 jam (daftar publik)</li>
                          <li>Cache statistik: 5 menit</li>
                          <li>Cache ulasan: 5 menit</li>
                          <li>
                            Cache otomatis di-refresh saat ada perubahan data
                          </li>
                        </ul>
                      </div>
                    </div>
